		...
		<div class="row justify-content-center mt-5">
			<section class="col-12 colsm-6 col-md-5">
				...
				<form class="form-container" action="CadastrarPacienteServlet">
					<h4 class="text-center mt-5">Cadastro</h4>
					...
					<button onclick="abrirAlerta()" type="submit" class="btn btn-primary btn-block mt-2">Cadastrar</button>

					<a href="ListarServlet"><button type="button" class="btn btn-secondary btn-block mt-3">Listar
						Pacientes</button></a>

					<a href="LogoutServlet"><button type="button"class="btn btn-danger btn-block mt-3 ">Logout</button></a>
