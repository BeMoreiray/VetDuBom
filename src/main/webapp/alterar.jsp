...
<link rel="stylesheet" type="text/css" href="css/altera.css">
...
<body>
		...
		<div class="row justify-content-center mt-5">
			<section class="col-12 colsm-6 col-md-5">
				...
				<form class="form-container" action="AlterarPacienteServlet">
					<h4 class="text-center mt-5">Editar Paciente</h4>
						...
						<input type="text" class="form-control" name="endereco"
							placeholder="Endereço" value="<%=pac.getEndereco() %>">
					<br>
	...
	<br>
						...
						<input type="text" class="form-control" name="raca"
							placeholder="Raça do Pet" value="<%=pac.getRaca() %>">
					
	<br>

					
						<input type="text" class="form-control" name="descricao"
							placeholder="Descrição do caso" value="<%=pac.getDescricao() %>">
					<br>


					<a href="tabela.jsp"><button type="submit" class="btn btn-primary btn-block mt-2">Alterar</button></a>
